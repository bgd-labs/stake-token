...
+}
+
+// lib/aave-helpers/lib/solidity-utils/src/contracts/oz-common/interfaces/IERC20.sol
+
...
+}
+
+// lib/aave-helpers/lib/solidity-utils/src/contracts/oz-common/interfaces/IERC20Permit.sol
+
...
+}
+
+// lib/aave-helpers/lib/solidity-utils/src/contracts/utils/interfaces/IRescuable.sol
+
+/**
+ * @title IRescuable
+ * @author BGD Labs
...
+   * caller's tokens.
    ...
    * Returns a boolean value indicating whether the operation succeeded.
    *
@@ -236,47 +939,329 @@ interface IERC20 {
    *
    * Emits an {Approval} event.
    */
-  function approve(address spender, uint256 amount) external returns (bool);
...
@@ -1297,11 +2046,11 @@ library SafeCast {
    * Requirements:
    *
...
@@ -2671,7 +3898,7 @@ library ShortStrings {
     ShortString value,
     string storage store
...
+}
+
+// lib/aave-helpers/lib/solidity-utils/src/contracts/oz-common/SafeERC20.sol
+
...
@@ -4177,17 +4577,15 @@ abstract contract BaseDelegation is IGovernancePowerDelegationToken {
...
+   * @dev See {IERC-5267}.
   ...
   function eip712Domain()
     public
@@ -4297,13 +4693,10 @@ abstract contract EIP712 is IERC5267 {
    *
...
+abstract contract ERC20 is OwnableUpgradeable, IERC20_1, IERC20Metadata, IERC20Errors {
+  struct DelegationAwareBalance {
...
+  using SafeERC20_1 for IERC20_1;
...
+      IERC20Permit_1(_smConfig.stakedToken).permit(
         msg.sender,
         address(this),
         amount,
